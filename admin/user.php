                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class='d-inline-flex'>
                                        <a class='d-inline-flex justify-content-center align-items-center bg-warning text-white' href='edit-ticket.php?id=<?php echo $row["name"]; ?>' style='height: 32px; width: 32px'>
